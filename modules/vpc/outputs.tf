...
output "agw_sg_id" {
  ...
  value       = aws_security_group.agw-sg.id
}

output "agw_sg_name" {
  description = "Security group name for API Gateway"
  value       = aws_security_group.agw-sg.name
}

output "ec2_connect_endpoint_sg_id" {
  description = "Security group ID for API Gateway"
  value       = aws_security_group.ec2-connect-endpoint-sg.id
}
